...
X = []
y_names = []
with open("taxon_eight_clades_new_alpha_noB1.txt", "r") as taxon_class:
    for line in taxon_class:
        class_name = line.split()[0]
        y_names.append(line.split()[1])
        y.append(class_name)

with open("eight_model_LOOCV_scores_alpha_noB1.txt", "r") as lcv_scores:
...
test_layer_list = []
test_layer_list.extend(list(product([7,8,9,10,11,12,13,14,15,14], repeat=1)))
test_layer_list.extend(list(product([7,8,9,10,11,12,13,14,15,14], repeat=2)))
test_layer_list.extend(list(product([7,8,9,10,11,12,13,14,15,14], repeat=3)))
test_layer_list.extend(list(product([7,8,9,10,11,12,13,14,15,14], repeat=4)))
